...
class Decide(object):
    def __init__(self, parent=None):
        self.setupUi(parent.new_window)

    def setupUi(self, Form):
        Form.setObjectName("Form")
        Form.resize(640, 768)
        self.horizontalLayoutWidget = QtWidgets.QWidget(Form)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(0, 10, 641, 441))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.MYH = QtWidgets.QLabel(self.horizontalLayoutWidget)
        ...
        self.MH = QtWidgets.QLabel(self.horizontalLayoutWidget)
        ...
        self.MYKY = QtWidgets.QLabel(self.horizontalLayoutWidget)
        self.MYKY.setObjectName("MYKY")
        self.horizontalLayout.addWidget(self.MYKY)
        self.tableView = QtWidgets.QTableView(Form)
        self.tableView.setGeometry(QtCore.QRect(0, 450, 641, 281))
        self.tableView.setObjectName("tableView")
        self.save = QtWidgets.QPushButton(Form)
        self.save.setGeometry(QtCore.QRect(550, 735, 75, 23))
        self.save.setObjectName("save")
        self.info = QtWidgets.QLabel(Form)
        self.info.setGeometry(QtCore.QRect(280, 740, 270, 16))
        self.info.setText("")
